...
LoopClosureDetection::LoopClosureDetection() {
  ...
  point_cloud_sub_ = nh_.subscribe(
      "surfel", 1000, &LoopClosureDetection::PointCloudCallback, this);
  odometry_sub_ = nh_.subscribe("local_pose", 1000,
                                &LoopClosureDetection::OdometryCallback, this);
}

void LoopClosureDetection::PointCloudCallback(
...
void LoopClosureDetection::OdometryCallback(const nav_msgs::Odometry& msg) {
